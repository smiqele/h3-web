  ...
  return (
    <>
      ...
      >
        <div
          className={`
            w-full h-12 px-6 border-x border-b rounded-b-lg
            flex items-center justify-between
            max-w-[1512px] mx-auto
            transition-colors duration-300
            ${
              scrolled
                ? 'bg-h3-white/20 backdrop-blur-xs border-gray-200'
        ...
        >
          ...
          <div className="flex items-center gap-10">
            <Image src="/img/h3-logo.svg" alt="H3" width={125} height={20} priority />
          </div>
